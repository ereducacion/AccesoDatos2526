...
public class AccesoBiblioteca {
	...
	public static void main(String[] args) {
	 	...
	 	try {
			...
			Connection conexion = DriverManager.getConnection("jdbc:mysql://192.168.1.2/biblioteca", "miusuario", "Pass!123456");
            ...
            while (resultado.next()) {
            		System.out.println(resultado.getString("Nombre") + "-" + resultado.getInt("Codigo"));
            }
